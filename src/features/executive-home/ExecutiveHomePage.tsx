...
const downstreamStatusLabel: Record<DownstreamAreaStatus, string> = { PROTECTED: 'Protegida', ATTENTION: 'Atenção', RISK: 'Risco', UNKNOWN: 'Desconhecida' };
