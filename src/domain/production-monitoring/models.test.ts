...
describe('production monitoring facts', () => {
  ...
  it('orders events newest first and derives WIP state counts', () => {
    ...
    expect(monitoringCounts([
      { lotId: '1', productionOrderId: '1', resourceId: 'DC01', scheduleVersionId: 'v08', plannedQuantity: 1, producedQuantity: 0, scheduledStart: '', status: 'NOT_STARTED', pauses: [], transitions: [], demonstrative: true, dataOrigin: 'SOURCE_DERIVED_PLAN', ruleStatus: 'BUSINESS_VALIDATION_REQUIRED' },
      { lotId: '2', productionOrderId: '2', resourceId: 'DC02', scheduleVersionId: 'v08', plannedQuantity: 1, producedQuantity: 1, scheduledStart: '', status: 'COMPLETED', pauses: [], transitions: [], demonstrative: true, dataOrigin: 'SOURCE_DERIVED_PLAN', ruleStatus: 'BUSINESS_VALIDATION_REQUIRED' },
