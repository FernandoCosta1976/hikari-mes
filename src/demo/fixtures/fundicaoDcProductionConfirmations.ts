...
/** Capability 06 migration (Section 19): the legacy dataset's historical producedQuantity facts become seed Production Confirmations, mirroring the reference scenario's own migration. */
